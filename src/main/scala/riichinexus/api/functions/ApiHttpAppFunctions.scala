...
import riichinexus.api.ApiRuntimeContext
import riichinexus.api.http.RouteContext
import riichinexus.api.http.functions.ApiRouterFunctions

object ApiHttpAppFunctions:
  ...
  def build(
    ...
    val routed = ApiRouterFunctions.httpApp(
      RouteContext(
