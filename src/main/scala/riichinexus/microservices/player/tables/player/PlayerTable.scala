package riichinexus.microservices.player.tables.player
...
object PlayerTable:
  ...
  private[riichinexus] def findById(connection: Connection, id: PlayerId): Option[Player] =
  ...
  private[riichinexus] def findByUserId(connection: Connection, userId: String): Option[Player] =
  ...
  private[riichinexus] def list(connection: Connection, query: PlayerListQuery): Vector[Player] =
  ...
  private[riichinexus] def findByIds(connection: Connection, ids: Vector[PlayerId]): Vector[Player] =
  ...
  private[riichinexus] def findByClub(connection: Connection, clubId: ClubId): Vector[Player] =
  ...
  private[riichinexus] def findAll(connection: Connection): Vector[Player] =
