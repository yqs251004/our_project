...
object ClubTable:
  ...
  private[riichinexus] def findById(connection: Connection, id: ClubId): Option[Club] =
  ...
  private[riichinexus] def findByName(connection: Connection, name: String): Option[Club] =
  ...
  private[riichinexus] def findByIds(connection: Connection, ids: Vector[ClubId]): Vector[Club] =
  ...
  private[riichinexus] def findAll(connection: Connection): Vector[Club] =
