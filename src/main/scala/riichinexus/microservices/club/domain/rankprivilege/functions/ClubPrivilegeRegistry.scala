package riichinexus.microservices.club.domain.rankprivilege.functions

import riichinexus.microservices.auth.objects.authorization.Permission
import riichinexus.microservices.club.objects.rankprivilege.{ClubPrivilegeCode, ClubPrivilegeDefinition}
